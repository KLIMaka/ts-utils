...
export declare function cookbook<Output>(factory: Fn<Cookbook<[]>, Task<Output, any>>): Task<Output, []>;
export declare function cookbookImmediate<Output>(handle: TaskHandle, factory: Fn<Cookbook<[]>, Task<Output, any>>): Promise<Output>;
